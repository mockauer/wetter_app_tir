<?php
	...
	foreach ($monate as $monat){		
		if ($monat == $akt_monat) {
			$temp_akt = $temperatur[$monat-1]/10;
	...
	switch ($zufallszahl){
		case 0:
			...
			break;
		case 1:
			$wetter = "leicht bewolkt";
			echo "<img src='img/leichtbewolkt.png' />";
			break;
		case 2:
			$wetter = "stark bewolkt";
		...
		$query ="INSERT INTO `wetter` (`id`, `datum`, `wetter`, `temperatur`) VALUES (NULL, '".date('Y-m-d', $time)."', '$wetter', '$temp_akt');";
		$all=$mysqli->query($query);
		echo "DB Eintrag: ".$query;
?>
